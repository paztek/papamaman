...
(function(window, angular, undefined) {
  ...
  var config = {
    ...
    signupUrl: '/authentication/signup',
    ...
    unlinkUrl: '/authentication/unlink/'
  };

  var providers = {
    google: {
      url: '/authentication/google',
      authorizationEndpoint: 'https://accounts.google.com/o/oauth2/authentication',
